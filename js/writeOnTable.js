...
// Padronizar os nomes das variaveis 
...
function writeOnTable(id) {
    ...
    const day = hour * 24;
    const year = day * 365; // Não tá sendo usado

    var ultimaColetaDate = bairroClicked.ultimaColeta; // Essa linha e a de baixo podem ser escritas juntas
    ultimaColetaDate = new Date(ultimaColetaDate); // var ultimaColetaDate = new Date(bairroClicked.ultimaColeta); exemplo
